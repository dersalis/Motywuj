...
{
    public partial class AddCitationPage : PhoneApplicationPage
    {
        public AddCitationPage()
        {
            InitializeComponent();

            // Dodaj appBar
            ApplicationBar = CreateAddCitationPageAppBar();
        }

        //
        // Tworzy ApplicationBar dla strony Widok cytatu
        //
        private ApplicationBar CreateAddCitationPageAppBar()
        {
            // Nowy AppBar
